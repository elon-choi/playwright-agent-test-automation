...
test.describe('KPA-079 시나리오 검증', () => {
  ...
  test('모바일 웹에서 회차 감상 이력이 있는 작품의 이어보기 확인', async ({ Given, When, Then, And, ai, loginPage, page }) => { 
    ...
    await When('사용자가 모바일 웹에서 회차 탭 영역을 클릭한다', null, { ai, loginPage, page }); 
