...
test.describe('KPA-088 시나리오 검증', () => {
  ...
  test('기다무 안내 팝업 노출 확인', async ({ Given, Then, And, ai, loginPage, page }) => { 
