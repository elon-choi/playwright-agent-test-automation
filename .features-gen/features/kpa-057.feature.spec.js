// Generated from: features/kpa-057.feature
import { test } from "../../steps/fixtures.ts";

test.describe('KPA-057 시나리오 검증', () => {

  test('운영중인 배너의 동작 및 노출 검증', async ({ Given, When, Then, And, ai, loginPage, page }) => { 
    await Given('사용자가 "https://page.kakao.com/" 사이트에 접속한다', null, { ai, loginPage, page }); 
    await And('운영중인 배너가 3개 이상 존재한다', null, { ai, loginPage, page }); 
    await When('사용자가 웹 페이지에 진입한 후 상단의 책 GNB 메뉴를 클릭한다', null, { ai, loginPage, page }); 
    ...
    await And('배너는 다음 요소들로 구성된다:', {"dataTable":{"rows":[{"cells":[{"value":"요소"}]},{"cells":[{"value":"배경 및 썸네일"}]},{"cells":[{"value":"메인타이틀"}]},{"cells":[{"value":"서브타이틀"}]},{"cells":[{"value":"뱃지"}]},{"cells":[{"value":"배너 순서"}]}]}}, { ai, loginPage, page }); 
  });
