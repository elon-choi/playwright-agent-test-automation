// Generated from: features/kpa-131.feature
import { test } from "../../steps/fixtures.ts";

test.describe('KPA-131 시나리오 검증', () => {

  test('무료 회차에서 좋아요 기능 검증', async ({ Given, When, Then, And, ai, loginPage, page }) => { 
    ...
    await Then('좋아요 버튼의 우측이 활성화된다', null, { ai, loginPage, page }); 
