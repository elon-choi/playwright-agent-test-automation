...
test.describe('KPA-090 시나리오 검증', () => {
  ...
  test('구매 이력이 없는 사용자가 회차 탭에서 메시지 노출 확인', async ({ Given, When, Then, And, ai, loginPage, page }) => { 
