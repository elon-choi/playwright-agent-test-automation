// Generated from: features/kpa-121.feature
import { test } from "../../steps/fixtures.ts";

test.describe('KPA-121 시나리오 검증', () => {

  test('무료 회차에서 다음 회차로 이동', async ({ Given, When, Then, And, ai, loginPage, page }) => { 
    ...
    await And('사용자가 "다음화 보기 >" 버튼을 클릭한다', null, { ai, loginPage, page }); 
