// Generated from: features/kpa-051.feature
import { test } from "../../steps/fixtures.ts";

test.describe('KPA-051 시나리오 검증', () => {
  ...
  test('운영중인 배너의 동작 및 노출 검증', async ({ Given, When, Then, And, ai, loginPage, page }) => { 
    ...
    await And('배너는 다음 요소로 구성되어 있다:', {"dataTable":{"rows":[{"cells":[{"value":"요소"}]},{"cells":[{"value":"배경 및 썸네일"}]},{"cells":[{"value":"메인타이틀"}]},{"cells":[{"value":"서브타이틀"}]},{"cells":[{"value":"뱃지"}]},{"cells":[{"value":"배너 순서"}]}]}}, { ai, loginPage, page }); 
  });
