// Generated from: features/kpa-044-1.feature
import { test } from "../../steps/fixtures.ts";

test.describe('KPA-044-1 구매작품 삭제 취소 검증 (테스트 계정 비용 절약용)', () => {

  test('삭제 확인 팝업에서 취소 시 구매작품 리스트 유지', async ({ Given, When, Then, And, ai, loginPage, page }) => {
    ...
    await When('삭제 확인 팝업이 노출되면 취소 버튼을 클릭한다', null, { ai, loginPage, page });
    await And('사용자가 편집 화면 하단의 취소 버튼을 클릭한다', null, { ai, loginPage, page });
    await Then('구매작품 리스트가 그대로 유지된다', null, { ai, loginPage, page });
  });
