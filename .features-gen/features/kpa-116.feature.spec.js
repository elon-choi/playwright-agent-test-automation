// Generated from: features/kpa-116.feature
import { test } from "../../steps/fixtures.ts";

test.describe('KPA-116 시나리오 검증', () => {

  test('무료 회차에서 원작소설로 이동', async ({ Given, When, Then, And, ai, loginPage, page }) => { 
    ...
    await Then('사용자는 해당 작품의 홈 페이지로 이동한다', null, { ai, loginPage, page }); 
  });
