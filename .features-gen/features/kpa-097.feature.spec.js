...
test.describe('KPA-097 시나리오 검증', () => {
  ...
  test('유료회차 이용권 미보유 상태에서 이용권 충전 페이지 이동', async ({ Given, When, Then, And, ai, loginPage, page }) => { 
